...
private:
	int index = 0, len = 0;
	unsigned char* packet_data = new unsigned char[61];
public:
	...
	void Insert(string a) {
		unsigned char* data = new unsigned char[len + 2 + a.length() + 4];
